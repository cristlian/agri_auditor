...
DEFAULT_PIPELINE_OUTPUT_DIR = PROJECT_ROOT / "workspace" / "pipeline_outputs"
DEFAULT_FEATURES_OUTPUT = DEFAULT_PIPELINE_OUTPUT_DIR / "features.csv"
DEFAULT_EVENTS_OUTPUT = DEFAULT_PIPELINE_OUTPUT_DIR / "events.json"
DEFAULT_REPORT_OUTPUT = DEFAULT_PIPELINE_OUTPUT_DIR / "audit_report.html"
DEFAULT_BENCHMARK_OUTPUT = DEFAULT_PIPELINE_OUTPUT_DIR / "gemini_benchmark.json"
